  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative overflow-hidden min-h-[88vh] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 w-full">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-lg md:text-xl font-body max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in delay-200">
      ...
      <section
        ...
        style={{
          background: 'linear-gradient(180deg, transparent 0%, rgba(9,24,16,0.6) 50%, transparent 100%)',
