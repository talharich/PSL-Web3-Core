...
import { Zap, LayoutDashboard, ShoppingBag, Home } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
     <div className="min-h-screen flex flex-col bg-[var(--psl-dark)] text-white overflow-hidden">
      {/* 🌌 Ambient Glow Background */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-200px] left-[-150px] w-[600px] h-[600px] rounded-full blur-[120px] opacity-30 bg-green-500" />
        <div className="absolute bottom-[-150px] right-[-150px] w-[500px] h-[500px] rounded-full blur-[120px] opacity-20 bg-emerald-400" />
      </div>

       {/* ADDED: Uniform black filter with 30% opacity over entire viewport */}
      <div 
        className="fixed inset-0 pointer-events-none z-[5]"
        style={{
          backgroundColor: 'rgba(0, 0, 0, 0.40)', // 25% opacity black overlay
        }}
      />
      ...
      <footer className="border-t border-white/10 bg-black/20 backdrop-blur-xl relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row justify-between items-center gap-3">

          <p className="text-xs text-gray-500">
            Dynamic Moments · Built with React × Web3 UI System
          </p>
